...
#line 3 "usb.c" /0
 ...
 UINT8C	MyDevDescr[] = { 0x12,0x01,0x00,0x02,0x00,0x00,0x00,8,
 ...
 0x07,0x05,0x81,0x03,8,0x00,0x0A,                        
 0x09,0x04,0x01,0x00,0x02,0x03,0x00,0x00,0x00,              
 0x09,0x21,0x11,0x01,0x00,0x01,0x22,sizeof(MY_HID_Report_Desc)&0xFF,sizeof(MY_HID_Report_Desc)>>8,              
 0x07,0x05,0x83,0x03,64,0x00,0x01,                         
 ...
 savePortCfg = ((unsigned char volatile xdata *) 0)[0x21EA];
   ((unsigned char volatile xdata *) 0)[0x21EA] |= 0x80;	 
 ...
 _nop_( );
   ((unsigned char volatile xdata *) 0)[0x21EA] = savePortCfg;
 if ( GPIO_IE & 0x80 ) {	 
 GPIO_IE &= ~ 0x80;	 
 GPIO_IE |= 0x80;
 }
 savePortCfg = ((unsigned char volatile xdata *) 0)[0x223C];
   ((unsigned char volatile xdata *) 0)[0x223C] |= 0x80|0x40;
 mDelaymS(30);  
   ((unsigned char volatile xdata *) 0)[0x223C] ^= savePortCfg;
 ...
 void	USB_DeviceInterrupt( void ) interrupt 7 using 1
 {
 UINT8 len,us,i;
 static	UINT8	D0SetupReqCode, D0SetupLen,CMD;
 static	PUINT8	pD0Descr;
 USB_DevIntNext:
 us = ((unsigned char volatile xdata *) 0)[0x223D]; 
 if(us & 0x20)             
 {
 switch(((unsigned char volatile xdata *) 0)[0x220F] & ( 0x20 | 0x18 | 0x07 ))      
 {
 case 0x10 | 0:                        
 case 0x20 | 0x10 | 0:
 switch( D0SetupReqCode ) {
 case 0x06:
 len = D0SetupLen >= 8 ? 8 : D0SetupLen;   
 memcpy( (((PUINT8X)0x1000)+0x00), pD0Descr, len );   
 D0SetupLen -= len;
 pD0Descr += len;
   ((unsigned char volatile xdata *) 0)[0x2208] = len;
   ((unsigned char volatile xdata *) 0)[0x2200] ^= 0x40;   
 break;
 case 0x05:
   ((unsigned char volatile xdata *) 0)[0x2207] = D0SetupLen;
   ((unsigned char volatile xdata *) 0)[0x2200] = 0x00 | 0x02;
 break;
 default:
   ((unsigned char volatile xdata *) 0)[0x2208] = 0;   
   ((unsigned char volatile xdata *) 0)[0x2200] = 0x00 | 0x02;
 break;
 }
 break;
 case 0x00 | 2:   
 case 0x20 | 0x00 | 2:
 if ( ((unsigned char volatile xdata *) 0)[0x220F] & 0x40 ) {   
 len = ((unsigned char volatile xdata *) 0)[0x220E];
 if(((((PUINT8X)0x1000)+0x80)[0] == 0x57) && ((((PUINT8X)0x1000)+0x80)[1] == 0xAB)){
 CMD = (((PUINT8X)0x1000)+0x80)[2];
 switch(CMD){
 case 0x01:
 memset(((PUINT8X)0x1000)+0xC0,0,64);
 (((PUINT8X)0x1000)+0xC0)[0] =  0x57; 
 (((PUINT8X)0x1000)+0xC0)[1] =  0xAB;
 (((PUINT8X)0x1000)+0xC0)[2] =  RGBMode;
   ((unsigned char volatile xdata *) 0)[0x220B] = len;
   ((unsigned char volatile xdata *) 0)[0x2203] = ((unsigned char volatile xdata *) 0)[0x2203] & ~0x03 | 0x00;  
 break;
 case 0x02:                                  
 RGBMode =(((PUINT8X)0x1000)+0x80)[4];
 ...
 (((PUINT8X)0x1000)+0xC0)[0] =  0x57; 
 (((PUINT8X)0x1000)+0xC0)[1] =  0xAB;
 (((PUINT8X)0x1000)+0xC0)[2] =  0xFA;
 (((PUINT8X)0x1000)+0xC0)[3] =  0xFA;
 (((PUINT8X)0x1000)+0xC0)[4] =  USB_IO;
 (((PUINT8X)0x1000)+0xC0)[5] =  USB_IO>>8;
 (((PUINT8X)0x1000)+0xC0)[6] =  0;
 (((PUINT8X)0x1000)+0xC0)[7] =  0;
 memcpy(&(((PUINT8X)0x1000)+0xC0)[8],USBRGBdataBuffer,USB_IO);
 
   ((unsigned char volatile xdata *) 0)[0x220B] = len;
   ((unsigned char volatile xdata *) 0)[0x2203] = ((unsigned char volatile xdata *) 0)[0x2203] & ~0x03 | 0x00;  
 break;
 case 0x04:
 i=(((PUINT8X)0x1000)+0x80)[4];
 memcpy(USBRGBdataBuffer+USB_IO,&(((PUINT8X)0x1000)+0x80)[8],i);
 USB_IO += i;
 memset(((PUINT8X)0x1000)+0xC0,0,64);
 (((PUINT8X)0x1000)+0xC0)[0] =  0x57; 
 (((PUINT8X)0x1000)+0xC0)[1] =  0xAB;
 ...
 case 0x10 | 3:   
 case 0x20 | 0x10 | 3:
   ((unsigned char volatile xdata *) 0)[0x2203] = ((unsigned char volatile xdata *) 0)[0x2203] & ~0x03 | 0x02;  
 if(CMD == 0x03){
 if(USB_IO>=128*4) {
 USB_IO = 0;
 break;
 ...
 (((PUINT8X)0x1000)+0xC0)[4] =  i;
 (((PUINT8X)0x1000)+0xC0)[5] =  0;
 (((PUINT8X)0x1000)+0xC0)[6] =  USB_IO;
 (((PUINT8X)0x1000)+0xC0)[7] =  USB_IO>>8;
 
 memcpy(&(((PUINT8X)0x1000)+0xC0)[8],USBRGBdataBuffer+USB_IO,i);
 USB_IO+=i;
   ((unsigned char volatile xdata *) 0)[0x220B] = len;
   ((unsigned char volatile xdata *) 0)[0x2203] = ((unsigned char volatile xdata *) 0)[0x2203] & ~0x03 | 0x00;  
 }
 ...
 case 0x20 | 0x10 | 1:
 FLAG = 1;
   ((unsigned char volatile xdata *) 0)[0x2201] = ((unsigned char volatile xdata *) 0)[0x2201] & ~0x03 | 0x02;  
 break;
 case 0x20 | 0x18 | 0:     
 case 0x20 | 0x18 | 1:    
 case 0x20 | 0x18 | 2:    
 ...
 case 0x20 | 0x18 | 6:    
 case 0x20 | 0x18 | 7:    
 D0SetupLen = ((PXUSB_SETUP_REQ)(((PUINT8X)0x1000)+0x00))->wLengthL;
 if(((PXUSB_SETUP_REQ)(((PUINT8X)0x1000)+0x00))->wLengthH ||D0SetupLen > 0x7f) D0SetupLen = 0x7f;   
 len = 0;   
 D0SetupReqCode = ((PXUSB_SETUP_REQ)(((PUINT8X)0x1000)+0x00))->bRequest;
 if((((PXUSB_SETUP_REQ)(((PUINT8X)0x1000)+0x00))->bRequestType & 0x60 ) == 0x00 ){  
 switch( D0SetupReqCode ) {  
 case 0x06:             
 switch(((PXUSB_SETUP_REQ)(((PUINT8X)0x1000)+0x00))->wValueH){
 case 0x01:   
 ...
 break;
 case 0x03:   
 switch( ((PXUSB_SETUP_REQ)(((PUINT8X)0x1000)+0x00))->wValueL ) {
 case 1:
 ...
 break;
 case 0x22:   
 switch( ((PXUSB_SETUP_REQ)(((PUINT8X)0x1000)+0x00))->wIndexL ) {        
 case 1:
 pD0Descr = MY_HID_Report_Desc;       
 ...
 break;
 case 0x05:                
 D0SetupLen = ((PXUSB_SETUP_REQ)(((PUINT8X)0x1000)+0x00))->wValueL;   
 break;
 case 0x08:
  (((PUINT8X)0x1000)+0x00)[0] = UsbConfig;
 if ( D0SetupLen >= 1 ) len = 1;
 break;
 break;
 case 0x09:
 UsbConfig = ((PXUSB_SETUP_REQ)(((PUINT8X)0x1000)+0x00))->wValueL;
 FLAG = 1;
 break;
 case 0x03:
 if(((PXUSB_SETUP_REQ)(((PUINT8X)0x1000)+0x00))->wValueL == 1){  
 sleep = 1;             
 }else{
 len = 0xFF;
 }
 break;
 case 0x01:
 if ( ( ((PXUSB_SETUP_REQ)(((PUINT8X)0x1000)+0x00))->bRequestType & 0x1F ) == 0x02 ) {   
 switch( ((PXUSB_SETUP_REQ)(((PUINT8X)0x1000)+0x00))->wIndexL ) {
 case 0x82:
   ((unsigned char volatile xdata *) 0)[0x2202] = ((unsigned char volatile xdata *) 0)[0x2202] & ~ ( 0x40 | 0x03 ) | 0x02;
 break;
 case 0x02:
   ((unsigned char volatile xdata *) 0)[0x2202] = ((unsigned char volatile xdata *) 0)[0x2202] & ~ ( 0x40 | 0x03 ) | 0x00;
 break;
 case 0x81:
   ((unsigned char volatile xdata *) 0)[0x2201] = ((unsigned char volatile xdata *) 0)[0x2201] & ~ ( 0x40 | 0x03 ) | 0x02;
 break;
 case 0x01:
   ((unsigned char volatile xdata *) 0)[0x2201] = ((unsigned char volatile xdata *) 0)[0x2201] & ~ ( 0x40 | 0x03 ) | 0x00;
 break;
 default:
 len = 0xFF;   
 break;
 ...
 break;
 case 0x0A:
  (((PUINT8X)0x1000)+0x00)[0] = 0x00;
 if ( D0SetupLen >= 1 ) len = 1;
 break;
 case 0x00: 
  (((PUINT8X)0x1000)+0x00)[0] = 0x00;
  (((PUINT8X)0x1000)+0x00)[1] = 0x00;
 ...
 }else if ( ( ((PXUSB_SETUP_REQ)(((PUINT8X)0x1000)+0x00))->bRequestType & 0x60 ) != 0x00 ) {   
 switch( D0SetupReqCode )
 {
 case 0x01: 
 break;
 ...
 break;
 case 0x09: 
 Feature = ((PXUSB_SETUP_REQ)(((PUINT8X)0x1000)+0x00))->wValueH;
 break;
 case 0x0A: 
 break;
 case 0x0B: 
...
#line 461 "usb.c" /0
 ...
 if ( len == 0xFF ) {   
 D0SetupReqCode = 0xFF;
   ((unsigned char volatile xdata *) 0)[0x2200] = 0x80 | 0x40 | 0x0C | 0x03;   
 }
 else if ( len <= 8 ) {   
 
   ((unsigned char volatile xdata *) 0)[0x2208] = len;
   ((unsigned char volatile xdata *) 0)[0x2200] = 0x80 | 0x40 | 0x00 | 0x00;   
 }
 else {   
   ((unsigned char volatile xdata *) 0)[0x2208] = 0;   
   ((unsigned char volatile xdata *) 0)[0x2200] = 0x80 | 0x40 | 0x00 | 0x00;   
 ...
 if( (((PUINT8X)0x1000)+0x40)[0] & 0x01 ){
 
 }
 else{
 
 }
 if( (((PUINT8X)0x1000)+0x40)[0] & 0x02 ){
 
 }
 else{
 
 }
 if( (((PUINT8X)0x1000)+0x40)[0] & 0x04 ){
   ...
   ((unsigned char volatile xdata *) 0)[0x2200] ^= 0x80;
...
#line 519 "usb.c" /0
 break;
   ...
   ((unsigned char volatile xdata *) 0)[0x220F] = 0;
 
 }else if(us & 0x04) 
 {
   ((unsigned char volatile xdata *) 0)[0x223D] |= 0x04;
 if(us & 0x08){        
...
#line 544 "usb.c" /0
   ((unsigned char volatile xdata *) 0)[0x223C] = 0;
   ((unsigned char volatile xdata *) 0)[0x2200] = 0x00 | 0x02;
   ((unsigned char volatile xdata *) 0)[0x2201] = 0x10 | 0x02;
   ((unsigned char volatile xdata *) 0)[0x2202] = 0x10 | 0x00;
   ((unsigned char volatile xdata *) 0)[0x2203] = 0x10 | 0x02;
 
   ((unsigned char volatile xdata *) 0)[0x220C] = 0x04|0x01;  
   ((unsigned char volatile xdata *) 0)[0x2207] = 0;
   ((unsigned char volatile xdata *) 0)[0x2237] = 0x7F;              
   ((unsigned char volatile xdata *) 0)[0x223D] = 0xFF;
 FLAG = 0;
   ((unsigned char volatile xdata *) 0)[0x223B] = 0x04|0x02|0x01;
   ((unsigned char volatile xdata *) 0)[0x223C] = 0x80;
   ((unsigned char volatile xdata *) 0)[0x223D] |= 0x01;
 }else 
 {
...
#line 563 "usb.c" /0
 ...
 if(((unsigned char volatile xdata *) 0)[0x223D] &(0x20|0x04|0x01)) goto USB_DevIntNext;
